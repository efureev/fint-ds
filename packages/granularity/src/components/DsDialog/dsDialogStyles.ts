...
const header = 'flex items-center justify-between gap-4 flex-1 min-w-0 text-[14px] font-700 border-b border-[var(--border)] px-5 py-3'
const footer = 'border-t border-[var(--border)] px-5 py-4'
