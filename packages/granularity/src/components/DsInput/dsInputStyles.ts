...
const template = [
  ...
  'absolute inset-y-0 right-0 flex items-center justify-center border-l border-[var(--border)] px-2 text-[var(--muted-foreground)] pointer-events-none select-none truncate',
]
