...
<template>
  <nav class="fixed bottom-0 left-0 right-0 border-t border-[var(--border)] bg-[var(--background)] px-2 pb-[env(safe-area-inset-bottom)] sm:hidden">
    <div class="h-14 flex items-center justify-around">
      <button
        ...
        :class="it.value === props.modelValue ? 'text-[var(--primary)]' : 'text-[var(--muted-foreground)] hover:text-[var(--foreground)]'"
