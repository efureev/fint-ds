...
import { DS_COLLAPSE_CONTEXT, type DsCollapseContext, type DsCollapseModelValue, type DsCollapseValue } from '@/components/dsCollapseContext'
...
const activeSet = computed(() => {
  ...
  if (typeof value === 'string' || typeof value === 'number') {
    // Be permissive (in case consumer toggles `accordion` dynamically).
    return new Set<DsCollapseValue>([value])
  }
