...
import { dsButtonClass, type DsButtonSize, type DsButtonVariant } from '@/components/dsButtonStyles'
...
const props = withDefaults(
  defineProps<{
    ...
    /** Form-related attributes (native radio participation). */
    required?: boolean
    form?: string
...
const buttonClassName = computed(() => {
  const v = checked.value ? props.selectedButtonVariant : props.buttonVariant
...
<template>
  ...
  >
    <!-- Native form control (kept out of the visual/UI tree). -->
    <input
      type="radio"
      :checked="checked"
