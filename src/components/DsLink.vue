...
const resolvedRel = computed(() => {
  ...
  if (props.external) return 'noopener noreferrer'
  return undefined
})
...
const className = computed(() => {
  return [base, sizeClass.value, underlineClass.value, variantClass.value, disabledClass.value].filter(Boolean).join(' ')
})
</script>
