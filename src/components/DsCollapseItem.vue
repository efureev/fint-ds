...
import { DS_COLLAPSE_CONTEXT, type DsCollapseValue } from '@/components/dsCollapseContext'
...
const resolvedName = computed<DsCollapseValue>(() => {
  if (typeof props.name === 'string' || typeof props.name === 'number') return props.name
  return uid
})
